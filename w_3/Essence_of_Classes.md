...
- Статичний метод — якась функція (напр. GPS), яка йде разом з кресленням і знаходиться в кожній машині, що зроблена по креселеню.
...
- Клас — це визначення загальної поведінки для об'єктів, які цей клас породжує.
    - Об'єкт — буде мати поведінку, яку задає клас і відрізнятися від інших об'єктів — своїм станом. Якщо ж стан одинаковий, то буде як два одинкових автомобіля — дві різні сутності, але виглядають — одинаково.
...
В ООП — все є об'єктом. Це потрібно, щоб контролювати вже самі класи (які є теж об'єктами), підзавантажувати їх підчас роботи програми, чи старту і т.д.
